...
# Advanced CSS (Preserving your exact styles)
st.markdown("""
    <style>
    .stApp {
    ...
    if not st.session_state["authenticated"]:
        ...
        with col2:
            ...
            if c2.button("Forgot Password?"):
                st.info("💡 Please contact **Lead Analyst Arathi (1U23CA013ARATHI)** for access recovery.")
        return False
    return True
...
if login_page():
    ...
    # --- 5. PAGE LOGIC (Preserving your exact content) ---
